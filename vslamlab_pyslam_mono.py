...
if __name__ == "__main__":   
    ...
    # Ensure VSLAMLAB_DATASET exists
    data['VSLAMLAB_DATASET'] = {}
    data['VSLAMLAB_DATASET']['type'] = 'vslamlab'
    data['VSLAMLAB_DATASET']['sensor_type'] = 'mono'
    data['VSLAMLAB_DATASET']['base_path'] = args.sequence_path
    data['VSLAMLAB_DATASET']['name'] = args.exp_folder
    data['VSLAMLAB_DATASET']['settings'] = args.calibration_yaml
    ...
    data['VSLAMLAB_DATASET']['groundtruth_file'] = os.path.join(args.sequence_path,'groundtruth.txt')
    data['VSLAMLAB_DATASET']['fps'] = calibration['Camera.fps']

    # Optionally, add timestamps
    data['VSLAMLAB_DATASET']['timestamps'] = 'times.txt'
    
    with open(config_path, 'w') as f:
        yaml.dump(data, f, sort_keys=False)

    config = Config()
    config.dataset_settings['rgb_txt'] = args.rgb_txt

    args.headless = not bool(int(args.verbose))
    ###########################################################################################
